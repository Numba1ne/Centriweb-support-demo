...
/**
 * GET /api/tenants/by-domain?domain=support.acmeagency.com
 * Returns tenant configuration by custom domain
 */
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    if (error || !tenant) {
      console.error('[API] Tenant not found for domain:', domain, error);
    ...
    console.error('[API] Error fetching tenant by domain:', error);
